...
public class MonumentController {
    ...
    @GetMapping("/")
    public List<MonumentoDTO> getMonumentos(@RequestParam (name="localidad", defaultValue = "null") String localidad, @RequestParam (name="codigoPostal", defaultValue = "null") String codPostal,
