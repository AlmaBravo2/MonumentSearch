...
2. Se llama al Wrapper Comunidad Valenciana que obtiene los datos en el formato establecido deseado pero manteniendo el esquema original. [Dicho Wrapper se encuentra en la carpeta src/main/java/com/wrapper/comunidadValenciana/Wrapper]
